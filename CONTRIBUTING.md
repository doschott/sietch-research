...
Written permission from Funcom has been requested and is pending. Until a written answer is received, this repository contains documentation and planning only. No agent play takes place in Dune: Awakening.
...
- Secrets, credentials, server passwords, or personal data
